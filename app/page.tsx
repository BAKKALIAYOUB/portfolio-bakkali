        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section id="contact">
            ...
            <div className="rounded-xl border bg-card shadow p-4 md:p-6">
              <div className="space-y-4">
                <a href={`mailto:${aboutYou.email}`} className="flex items-center text-sm text-muted-foreground hover:text-primary">
                  <MdEmail className="mr-2" /> {aboutYou.email}
                </a>
                <a href="https://github.com/BAKKALIAYOUB" className="flex items-center text-sm text-muted-foreground hover:text-primary">
                  <SiGithub className="mr-2" /> BAKKALIAYOUB
                </a>
                <div className="flex items-center text-sm text-muted-foreground">
                  <FaPhoneAlt className="mr-2" /> +212694961984
                </div>
                <a href="https://www.linkedin.com/in/ayoub-bakkali-874534241/" className="flex items-center text-sm text-muted-foreground hover:text-primary">
